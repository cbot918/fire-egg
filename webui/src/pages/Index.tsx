      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            <PlayerStats attack={150} defense={120} money={2500} title={"Knight"} picture={"assets/pictures/heros/knight.jpg"}/>
            <Equipment 
          ...
          <div className="lg:col-span-1 space-y-4">
            <PlayerStats attack={130} defense={140} money={1800} title={"Mage"} picture={"assets/pictures/heros/mage.png"}/>
            <Equipment 
              weapon={{ name: item.cards[0].name, stats: "+"+ item.cards[0].attack +" 攻擊" }}
              armor={{ name: item.cards[1].name, stats: "+"+ item.cards[1].defend +" 防禦" }}
              pants={{ name: item.cards[2].name, stats: "+"+ item.cards[2].defend +" 防禦" }}
          ...
          <div className="lg:col-span-1 space-y-4">
            <PlayerStats attack={130} defense={140} money={1800} title={"Assassin"} picture={"assets/pictures/heros/assassin.png"}/>
            <Equipment 
              weapon={{ name: item.cards[0].name, stats: "+"+ item.cards[0].attack +" 攻擊" }}
              armor={{ name: item.cards[1].name, stats: "+"+ item.cards[1].defend +" 防禦" }}
              pants={{ name: item.cards[2].name, stats: "+"+ item.cards[2].defend +" 防禦" }}
